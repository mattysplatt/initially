 ...
 PopStars: [
  ...
  },
  {
    ...
    clues: [
      ...
      "Hits include '7 rings' and 'thank u, next'",
      "Former Nickelodeon actress",
      "Powerful four-octave vocal range",
      "Known for her signature ponytail"
    ]
  },
  {
    initials: "D.L.",
    ...
    clues: [
      ...
      "Known for 'Don't Start Now' and 'Levitating'",
      "Won Best New Artist at the 2019 Grammys",
      "Famous for her dance-pop sound",
      "Model before music career"
    ]
  },
  {
    initials: "B.E.",
    ...
    clues: [
      "American singer-songwriter",
      "Breakout hit 'bad guy'",
      "Known for her unique style and dark pop sound",
      "Youngest artist to win the top four Grammys in one night",
      "Collaborates with her brother Finneas"
    ]
  },
  {
    initials: "O.R.",
    ...
    clues: [
      ...
      "Hits include 'drivers license' and 'good 4 u'",
      "Starred in 'High School Musical: The Musical: The Series'",
      "Debut album 'SOUR' was a massive hit",
      "Noted for her emotional songwriting"
    ]
  },
  {
    initials: "J.B.",
    ...
    clues: [
      "Canadian pop singer",
      "Discovered on YouTube as a teenager",
      "Hits include 'Sorry' and 'Peaches'",
      "Married to Hailey Baldwin",
      "Global influence since the late 2000s"
    ]
  },
  {
    initials: "H.S.",
    ...
    clues: [
      ...
      "Solo hits include 'Watermelon Sugar' and 'As It Was'",
      "Known for his gender-fluid fashion",
  ...
  },
  {
    ...
    clues: [
      ...
      "Hits include 'Lose You to Love Me' and 'Rare'",
      "Starred in 'Wizards of Waverly Place'",
      "Advocate for mental health",
      "Founder of Rare Beauty"
    ]
  },
  {
    initials: "S.M.",
    ...
    clues: [
      ...
      "Breakout with 'Stitches' and 'Treat You Better'",
      "Documentary 'In Wonder' on Netflix",
      "Known for guitar-driven pop",
  ...
  },
  {
    ...
    clues: [
      "Cuban-American pop star",
      "Former member of Fifth Harmony",
      "Hits include 'Havana' and 'Señorita'",
      "Acted in 'Cinderella' (2021)",
  ...
  },
  {
    ...
    clues: [
      ...
      "Hits include 'Say So' and 'Woman'",
      "Known for viral TikTok songs",
      "Eclectic and meme-savvy pop persona",
      "Grammy winner"
    ]
  },
  {
    ...
    clues: [
      "American rapper and singer",
      "Viral hit 'Old Town Road'",
      "Known for bold visuals and LGBTQ+ advocacy",
      "Hits include 'MONTERO (Call Me By Your Name)'",
  ...
  },
  {
    ...
    clues: [
      "American pop icon",
      "Known for 'Shallow' and 'Rain on Me' (with Ariana Grande)",
      "Starred in 'A Star Is Born'",
      "Famous for unique fashion",
  ...
  },
  {
    ...
    clues: [
      ...
      "Known for 'Attention' and 'See You Again'",
      "Perfect pitch and viral TikToks",
      "Collaborated with BTS and Jungkook",
  ...
  },
  {
    ...
    clues: [
      "American singer-songwriter",
      "Hits include 'Meant to Be' and 'I'm a Mess'",
      "Frequent collaborator with G-Eazy and David Guetta",
      "Albanian descent",
      "Known for her songwriting as well as singing"
    ]
  },
  {
    initials: "D.L.",
    ...
    clues: [
      ...
      "Advocate for mental health and LGBTQ+ rights",
      "Starred in 'Camp Rock'",
      "Open about her personal struggles"
    ]
  },
  {
    initials: "K.P.",
    ...
    clues: [
      ...
      "Hits include 'Roar' and 'Firework'",
      "Judge on 'American Idol'",
      "Known for colorful, whimsical music videos",
  ...
  },
  {
    ...
    clues: [
      "American pop singer",
      "Known for 'Sweet But Psycho'",
      "Distinctive asymmetrical hairstyle",
  ...
  },
  {
    ...
    clues: [
      "American singer and actress",
      "Hits include 'Midnight Sky' and 'Flowers'",
      "Former Disney Channel star",
      "Known for her edgy reinventions",
  ...
  },
  {
    ...
    clues: [
      ...
      "Hits include 'Whats Poppin' and 'First Class'",
      "Known for clever wordplay",
      "Collaborated with Lil Nas X",
  ...
  },
  {
    ...
    clues: [
      "British singer-songwriter",
      "Known for 'Stay With Me' and 'Unholy'",
      "Came out as non-binary in 2019",
      "Multiple Grammy Awards",
      "Collaborated with Kim Petras"
    ]
  },
  {
    initials: "C.G.",
  ...
  },
  {
    ...
    answer: "Nicki Minaj",
    clues: [
      "Trinidadian-American rapper and singer",
      "Hits include 'Super Bass' and 'Starships'",
      "Known for colorful wigs and alter egos",
      "Queen of rap features",
      "Grammy-nominated"
    ]
  },
  {
    ...
    clues: [
      ...
      "Hits include 'Love Me Like You Do' and 'Burn'",
      "Known for ethereal vocals",
      "Collaborated with Calvin Harris",
      "Married to Caspar Jopling"
    ]
  },
  {
    initials: "T.S.",
    ...
    clues: [
      ...
      "Hits include 'Rush' and 'Youth'",
      "Openly gay pop icon",
      "Starred in 'Boy Erased'",
      "Distinctive synth-pop sound"
    ]
  },
  {
    initials: "J.J.",
    ...
    clues: [
      ...
      "Hits include 'You Don't Know Me' and 'Breathe'",
      "Frequent collaborator with pop vocalists",
      "Nominated for Grammy and BRIT Awards",
  ...
  },
  {
    ...
    clues: [
      ...
      "Hits include 'Selfish' and 'Reckless'",
  ...
  },
  {
    ...
    clues: [
      "American singer and actress",
      "Hits include 'Feather' and 'Nonsense'",
      "Starred in 'Girl Meets World'",
      "Opened for Taylor Swift's Eras Tour",
  ...
  },
  {
    ...
    clues: [
      ...
      "Hits include 'Let You Love Me' and 'Anywhere'",
      "Judge on 'The Masked Singer UK'",
      "Acted in 'Fifty Shades' movies",
      "Kosovar-Albanian heritage"
    ]
  },
  {
    initials: "L.SS.",
    answer: "Lauren Spencer Smith",
    clues: [
      "Canadian singer-songwriter",
      "Viral hit 'Fingers Crossed'",
  ...
  },
  {
    ...
    clues: [
      ...
      "Hits include 'Unholy' (with Sam Smith)",
      "Transgender pop icon",
  ...
  {
    initials: "S.S.",
    answer: "Stephen Sanchez",
    clues: [
      "American singer-songwriter",
      "Hit single 'Until I Found You'",
      "Retro-inspired pop sound",
      "Gained popularity on TikTok",
      "Known for heartfelt love songs"
    ]
  },
  {
    initials: "B.B.",
  ...
  },
  {
    ...
    clues: [
      ...
      "Hits include 'You Broke Me First' and 'greedy'",
      "Former 'So You Think You Can Dance' contestant",
      "Debut album 'I Used to Think I Could Fly'",
      "Known for confessional lyrics"
    ]
  },
  {
    initials: "C.BP.",
    answer: "Caroline Polachek",
    clues: [
      "American singer-songwriter",
      "Hits include 'So Hot You're Hurting My Feelings'",
      "Formerly of Chairlift",
      "Experimental pop artist",
      "Praised for her vocal range"
    ]
  },
  {
    initials: "T.S.",
    answer: "Troye Sivan",
    clues: [
      "Australian pop star and actor",
      "Hits include 'Bloom' and 'My My My!'",
      "Starred in 'Boy Erased'",
      "Openly gay and LGBTQ+ icon",
      "Known for synth-pop and honest lyrics"
    ]
  },
    {
    initials: "B.B.",
    ...
    clues: [
      ...
      "Global Latin trap and reggaeton star",
      "Hits include 'Dakiti' and 'Tití Me Preguntó'",
      "WWE wrestling appearances",
      "Billboard's 2022 Artist of the Year"
    ]
  },
  {
    initials: "C.B.",
    ...
    clues: [
      ...
      "Hits include 'Bodak Yellow' and 'WAP'",
      "Former reality TV star",
      "Known for outspoken personality",
      "First solo female to win Best Rap Album Grammy"
    ]
  },
  {
    initials: "R.A.",
    answer: "Rauw Alejandro",
    clues: [
      "Puerto Rican singer and songwriter",
      "Known for reggaeton and Latin pop",
      "Hits include 'Todo de Ti' and 'BESO' (with Rosalía)",
      "Won Latin Grammy for Best New Artist",
      "Dated Rosalía"
    ]
  },
  {
    ...
    clues: [
      "American singer and actress",
      "Hits include 'Mamiii' and 'Mayores'",
      "Bilingual English/Spanish releases",
      "Starred in 2017's 'Power Rangers' movie",
      "Latin American Music Award winner"
    ]
  },
  {
    initials: "L.C.",
  ...
  },
  {
    ...
    clues: [
      "American rapper turned pop-punk singer",
      "Hits include 'Bloody Valentine' and 'my ex's best friend'",
      "Acted in 'The Dirt'",
      "Known for pink guitar and tattoos",
      "Dated Megan Fox"
    ]
  },
  {
    ...
    clues: [
      ...
      "Hits include 'Heaven' and 'Thank God'",
      "First Black artist to headline Houston Rodeo",
      "Duets with wife Katelyn Brown"
    ]
  },
  {
    initials: "M.T.S",
  ...
  },
  {
    ...
    clues: [
      "American singer-songwriter",
      "Known for 'Let Me Down Slowly'",
      "Storytelling in lyrics",
      "Soft, melodic vocal style",
      "Popular on social media"
    ]
  },
  {
    initials: "S.W.",
    answer: "Summer Walker",
    clues: [
      "American R&B singer-songwriter",
      "Hits include 'Girls Need Love' and 'Playing Games'",
      "Known for honest, raw lyrics",
      "Album 'Over It' debuted at No. 2 on Billboard 200",
      "Collaborated with Drake and SZA"
    ]
  },
  {
    initials: "M.R.",
    ...
    clues: [
      "American singer-songwriter",
      "Breakout with 'Alaska' after Pharrell Williams endorsement",
      "Hits include 'Light On' and 'Love You for a Long Time'",
      "Grammy-nominated",
      "Known for indie-pop sound"
    ]
  },
  {
    initials: "C.C.",
    ...
    clues: [
      ...
      "Known for 'Your Shirt' and 'you were good to me' (with Jeremy Zucker)",
      "Blends pop, electronic, and indie",
      "Open about mental health",
      "Tours with Quinn XCII"
    ]
  },
  {
    initials: "Q.X.",
    ...
    clues: [
      "American singer-songwriter",
      "Blends pop, reggae, and hip-hop",
      "Hits include 'Stay Next To Me' and 'Straightjacket'",
      "Collaborates with Chelsea Cutler",
      "Known for upbeat, summer vibes"
    ]
  },
  {
    initials: "R.W.",
    ...
    clues: [
      ...
      "Known for funky, colorful style",
      "Hits include 'Photo ID' and 'Disco Man'",
      "Former 'American Idol' contestant",
      "Praised for energetic live shows"
    ]
  },
  {
    initials: "G.A.",
    ...
    clues: [
      ...
      "Hits include 'Heat Waves' and 'Gooey'",
      "Fronted by Dave Bayley",
      "Nominated for Grammy Best New Artist 2022",
      "Psychedelic, experimental pop sound"
    ]
  },
  {
    initials: "P.P.",
    answer: "Pink Pantheress",
    clues: [
      "British singer and producer",
      "Viral on TikTok with 'Boy's a Liar'",
      "Blends drum and bass, garage, and pop",
      "Debut album 'Heaven knows'",
      "Mysterious online persona"
    ]
  },
  {
    initials: "A.P.",
    ...
    clues: [
      ...
      "Hits include 'Eugene' and 'Black Dog'",
      "Mercury Prize winner",
      "Known for gentle vocals and honest lyrics",
  ...
  },
  {
    ...
    clues: [
      ...
      "Hits include 'Bad Habit' and 'Dark Red'",
      "Member of The Internet",
      "Blends funk, R&B, and pop",
  ...
  },
  {
    ...
    clues: [
      ...
      "Hits include 'Better Days' and 'I Wrote A Song'",
      "Represented UK at Eurovision 2023",
      "Known for witty, empowered lyrics",
      "Debut album 'Sorry I'm Late'"
    ]
  },
  {
    initials: "P.S.",
    answer: "Paolo Sandejas",
    clues: [
      "Filipino pop singer-songwriter",
      "Known for 'Sway' and 'Different Shade of Blue'",
      "Young breakout artist",
      "Gained popularity on TikTok",
      "Mixes pop with indie influences"
    ]
  },
  {
    initials: "J.B.",
    ...
    clues: [
      ...
      "Starred in 'High School Musical: The Musical: The Series'",
      "Hits include 'Lie Lie Lie' and 'Feel Something'",
      "Known for heartfelt ballads",
      "Disney Channel background"
    ]
  },
  {
    initials: "C.L.",
    ...
    clues: [
      "American rapper and singer",
      "Hits include 'Players' and 'No More Parties'",
      "Known for energetic performances",
      "Daughter of rapper Benzino",
      "Viral on TikTok"
    ]
  },
  {
    ...
    clues: [
      "American singer-songwriter",
      "Hits include 'Numb Little Bug'",
      "Known for honest, conversational lyrics",
      "Gained popularity through TikTok",
      "Debut EP 'Egg in the Backseat'"
    ]
  },
  {
    initials: "C.A.",
    answer: "Chase Atlantic",
    clues: [
      "Australian pop-rock band",
      "Hits include 'Friends' and 'Swim'",
      "Known for moody, atmospheric sound",
      "Fronted by Mitchel Cave",
      "Popular on alternative radio"
    ]
  },
  {
    initials: "K.U.",
    ...
    clues: [
      ...
      "Hits include 'telepatía' and 'After the Storm'",
      "Grammy-winning album 'Isolation'",
      "Blends R&B, soul, and pop",
      "Collaborated with Tyler, the Creator"
    ]
  },
  {
    initials: "T.L.",
    ...
    clues: [
      ...
      "Hits include 'Habits (Stay High)' and 'Disco Tits'",
      "Known for raw, confessional lyrics",
      "Open about sexuality and mental health",
      "Albums 'Queen of the Clouds' and 'Dirt Femme'"
    ]
  },
  {
    initials: "J.D.",
    answer: "Joy Denalane",
    clues: [
      "German soul singer-songwriter",
      "Hits include 'Change' and 'Let Yourself Be Loved'",
      "Known for blending soul, R&B, and pop",
      "Collaborated with Common and Bilal",
  ...
  },
  {
    ...
    clues: [
      "Canadian singer-songwriter",
      "Hits include 'Casanova' and 'Paper Love'",
      "Known for art-pop style",
      "Collaborated with Troye Sivan",
  ...
  },
  {
    ...
    clues: ["Dutch defender","Plays for Liverpool","UEFA Men's Player of the Year 2019","Known for his leadership and aerial ability","Key to Liverpool's defensive strength"]
  },
  {
    initials: "L.M.",
    answer: "Luka Modrić",
    clues: ["Croatian midfielder","Plays for Real Madrid","2018 Ballon d'Or winner","Led Croatia to 2018 World Cup final","Known for his passing and control"]
  },
  {
    initials: "H.K.",
    answer: "Harry Kane",
    clues: ["English striker","Plays for Bayern Munich","England national team captain","Tottenham Hotspur's all-time top scorer","Known for his finishing and consistency"]
  },
  {
    initials: "N.J.",
    answer: "Neymar Jr.",
    clues: ["Brazilian forward","Played for Barcelona and PSG","Known for his flair and dribbling","Helped Brazil win 2016 Olympic gold","One of the most expensive transfers ever"]
  },
  {
    initials: "A.G.",
    answer: "Antoine Griezmann",
    clues: ["French forward","Plays for Atlético Madrid","World Cup winner 2018","Known for his movement and finishing","Key player for France and Atletico"]
  },
  {
    initials: "J.B.",
    answer: "Jude Bellingham",
    clues: ["English midfielder","Plays for Real Madrid","Young star formerly at Borussia Dortmund","Known for his maturity and box-to-box play","England international"]
  },
  {
    initials: "T.A.",
    answer: "Trent Alexander-Arnold",
    clues: ["English right-back","Plays for Liverpool","Known for his assists and crossing","Premier League winner","England international"]
  },
  {
    initials: "S.M.",
    answer: "Sadio Mané",
    clues: ["Senegalese forward","Played for Liverpool and Bayern Munich","AFCON winner 2022","Known for his pace and work rate","Key to Liverpool's recent success"]
  },
  {
    initials: "A.A.",
    answer: "Alphonso Davies",
    clues: ["Canadian left-back","Plays for Bayern Munich","Known for his speed","CONCACAF Player of the Year","Key young talent"]
  },
  {
    initials: "J.K.",
    answer: "Joshua Kimmich",
    clues: ["German midfielder","Plays for Bayern Munich","Versatile and intelligent player","Known for his passing and leadership","Bundesliga winner"]
  },
  {
    initials: "A.B.",
    answer: "Alisson Becker",
    clues: ["Brazilian goalkeeper","Plays for Liverpool","Premier League and Champions League winner","Known for his reflexes and distribution","Brazil's number one"]
  },
  {
    initials: "E.M.",
    answer: "Edouard Mendy",
    clues: ["Senegalese goalkeeper","Plays for Chelsea","Champions League winner 2021","Key to Senegal's AFCON triumph","Known for his saves"]
  },
  {
    initials: "J.C.",
    answer: "João Cancelo",
    clues: ["Portuguese full-back","Plays for Manchester City and Barcelona (loan)","Known for his attacking play","Premier League winner","Versatile defender"]
  },
  {
    initials: "C.C.",
    answer: "Casemiro",
    clues: ["Brazilian midfielder","Plays for Manchester United","Former Real Madrid star","Multiple Champions League titles","Known for defensive skills"]
  },
  {
    initials: "R.D.",
    answer: "Rúben Dias",
    clues: ["Portuguese defender","Plays for Manchester City","Key to City's defensive line","Premier League Player of the Season 2020/21","Known for leadership"]
  },
  {
    initials: "T.K.",
    answer: "Toni Kroos",
    clues: ["German midfielder","Plays for Real Madrid","Multiple Champions League titles","Known for his passing and vision","World Cup winner 2014"]
  },
  {
    initials: "B.S.",
    answer: "Bukayo Saka",
    clues: ["English winger","Plays for Arsenal","Known for his creativity and energy","England international","Key to Arsenal's resurgence"]
  },
  {
    initials: "B.F.",
    answer: "Bruno Fernandes",
    clues: ["Portuguese midfielder","Plays for Manchester United","Known for goals and assists","Premier League standout","Portugal international"]
  },
  {
    initials: "M.M.",
    answer: "Mike Maignan",
    clues: ["French goalkeeper","Plays for AC Milan","Known for his reflexes","Serie A winner","France international"]
  },
  {
    initials: "P.F.",
    answer: "Phil Foden",
    clues: ["English midfielder","Plays for Manchester City","Young Player of the Year","Known for his dribbling and creativity","England international"]
  },
  {
    initials: "B.S.",
    answer: "Bernardo Silva",
    clues: ["Portuguese midfielder","Plays for Manchester City","Known for his dribbling and intelligence","Premier League winner","Portugal international"]
  },
  {
    initials: "T.C.",
    answer: "Thibaut Courtois",
    clues: ["Belgian goalkeeper","Plays for Real Madrid","Champions League and La Liga winner","Known for his height and saves","Belgium's number one"]
  },
  {
    initials: "A.H.",
    answer: "Achraf Hakimi",
    clues: ["Moroccan right-back","Plays for PSG","Formerly at Inter Milan and Borussia Dortmund","Known for his pace","Key to Morocco's 2022 World Cup run"]
  },
  {
    initials: "F.V.",
    answer: "Federico Valverde",
    clues: ["Uruguayan midfielder","Plays for Real Madrid","Known for his energy and versatility","La Liga and Champions League winner","Uruguay international"]
  },
  {
    initials: "M.R.",
